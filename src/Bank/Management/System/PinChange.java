...
public class PinChange extends JFrame implements ActionListener{
	...
	PinChange(String pinnumber) {
		...
		pintext.setBounds(100, 280, 700, 35);
		...
		pin.setBounds(245, 280, 180, 25);
		image.add(pin);
		
		JLabel repintext = new JLabel("Re-Enter New PIN");
		repintext.setBounds(100, 320, 700, 35);
		...
		repin.setBounds(245, 320, 180, 25);
		image.add(repin);
		
		change = new JButton("CHANGE");
		change.setBounds(280, 410, 150, 30);
